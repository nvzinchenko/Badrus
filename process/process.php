...
MAIL_FROM = 'marina_hummer@bk.ru', // от какого email будет отправляться письмо
...
MAIL_ADDRESS = 'valek-kc@mail.ru', // кому необходимо отправить письмо
...
MAIL_SMTP_HOST = 'ssl://smtp.mail.ru', // SMTP-хост
MAIL_SMTP_PORT = '465', // SMTP-порт
MAIL_SMTP_USERNAME = 'marina_hummer@bk.ru', // здесь нужно указать email пользователя с которого будет отправлять письмо (SMTP-пользователь)
MAIL_SMTP_PASSWORD = 'Marinochka17!'; // здесь нужно указать пароль от почты (SMTP-пароль)
